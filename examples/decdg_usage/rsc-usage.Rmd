---
title: "RStudio Connect Usage - Last `r as.numeric(params$daysback)` Days"
output: 
  flexdashboard::flex_dashboard:
    ...
    css: styles.css
params:
    content_guid: "1f73c14a-702e-4e57-9fd2-c61616d9cc0a"
    daysback: "365"
---
...
client <- connect(server = Sys.getenv("connect_server_int"),
                  api_key = Sys.getenv("connect_key_int"))
...
data_arr$shiny %>%
    ...
    {ggplot(., aes(month, visits)) + 
     ...
     theme_rstudio() + 
     labs(
       title = "AIMM Development Gap Visualization Tool",
       subtitle = "2023 traffic analysis",
       y = "# of Shiny Sessions",
       x = NULL
     )} #%>% 
    #ggplotly(tooltip = c("y")) %>% 
